        ...
        try {
            if (call.method.equals("initialize")) {
                ...
                FlareLane.setNotificationClickedHandler(new NotificationClickedHandler() {
                    @Override
                    public void onClicked(NotificationClickedEvent event) {
                        HashMap<String, Object> map = event.notification.toHashMap();
                        map.putAll(event.action.toHashMap());
                        invokeMethodOnUiThread("setNotificationClickedHandlerInvokeCallback", map);
                    }
                });
                ...
                FlareLane.setNotificationForegroundReceivedHandler(new NotificationForegroundReceivedHandler() {
                    ...
                    public void onWillDisplay(NotificationReceivedEvent notificationReceivedEvent) {
                        notificationEventCache.put(notificationReceivedEvent.notification.id, notificationReceivedEvent);
                        invokeMethodOnUiThread("setNotificationForegroundReceivedHandlerInvokeCallback", notificationReceivedEvent.notification.toHashMap());
                    }
                });
